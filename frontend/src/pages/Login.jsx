    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10">
          ...
          <p className="text-gray-600 mb-8">Sign in to your college community</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 text-[#e8684a] border-gray-300 rounded focus:ring-[#e8684a]" />
                <span className="ml-2 text-sm text-gray-600">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-sm text-[#e8684a] hover:text-[#d65a3d] font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link to="/signup" className="text-[#e8684a] hover:text-[#d65a3d] font-semibold">
              Sign up
            </Link>
          </p>
        </div>
